...
export default function AdminKaryawanPage() {
  ...
  const handleResetPassword = () => {
    ...
    resetPassword.mutate(
      ...
      {
        onSuccess: () => { toast.success("Kata sandi berhasil direset"); setNewPassword(""); setIsResetting(false); },
        onError: (err: any) => { toast.error(err?.data?.error || err?.message || "Gagal mereset kata sandi"); setIsResetting(false); },
      },
    );
  };
