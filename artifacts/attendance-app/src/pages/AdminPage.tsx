...
import {
  useGetAdminTodayAttendance,
  getGetAdminTodayAttendanceQueryKey,
...
export default function AdminPage() {
  ...
  const { data: todayData, isLoading: loadingToday } = useGetAdminTodayAttendance({
    query: { queryKey: getGetAdminTodayAttendanceQueryKey() },
  });

  const { data: pendingLeaves } = useGetAdminLeaveRequests(
    { status: "pending" },
    { query: { queryKey: getGetAdminLeaveRequestsQueryKey({ status: "pending" }) } },
  );
